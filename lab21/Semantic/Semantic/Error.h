...
#define ERROR_ENTRY_NODEF100(id) ERROR_ENTRY_NODEF10(id + 0), ERROR_ENTRY_NODEF10(id + 10), \
	ERROR_ENTRY_NODEF10(id + 20), ERROR_ENTRY_NODEF10(id + 30),	ERROR_ENTRY_NODEF10(id + 40), \
	ERROR_ENTRY_NODEF10(id + 50), ERROR_ENTRY_NODEF10(id + 60), ERROR_ENTRY_NODEF10(id + 70), \
...
namespace Error {
	...
	ERROR geterrorin(int, int = -1, int = -1);
};
