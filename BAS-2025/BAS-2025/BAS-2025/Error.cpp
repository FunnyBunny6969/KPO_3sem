...
namespace Error
{
    ...
    ERROR errors[ERROR_MAX_ENTRY] =
    {
        ...
        ERROR_ENTRY(205, "Невозможно преобразовать hex (невалидный формат)"),
        ERROR_ENTRY(206, "Превышен размер строкового литерала"),
        ERROR_ENTRY(207, "Превышен максимальное допустимое значение UINT при присвоении"),
        ERROR_ENTRY(208, "Необъявленный идентификатор"),
        ...
        ERROR_ENTRY_NODEF(703), //, "Необъявленный идентификатор"),
        ...
        ERROR_ENTRY(707, "Недопустимый тип данных для сравнения в switch"), 
		ERROR_ENTRY(708, "Использование пустого строкового литерала недопустимо"),
		ERROR_ENTRY(709, "Попытка переопределить параметр функции"),
		...
		ERROR_ENTRY_NODEF(722), //, "Оператор return используется вне тела функции"),
